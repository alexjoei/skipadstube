...
1. **Instala el APK.** Abre `skipadstube-0.2.5.apk` en el móvil y pulsa **Instalar**. Si lo pide, permite **Instalar aplicaciones desconocidas** para el navegador o gestor de archivos que estés usando.
...
- **Tenías la versión anterior:** esta versión se instala como una app nueva. Desactiva el servicio antiguo y activa **skipadstube para YouTube**; los ajustes anteriores no se copian.
...
Si actualizas a 0.2.5, instala el APK encima y desactiva y reactiva **skipadstube para YouTube** en Accesibilidad para cargar la nueva configuración.
